...
//Allows us to declare the user input variable in the local scope.
// do {
//     var exit = confirm("Would you like to exit?");
// } while (!exit);
...
// do {
//     var color = prompt("Please enter a color. Use 'blue' to exit.");
// } while (color !== 'blue');
