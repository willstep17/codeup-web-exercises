...
// var isConflict = confirm("Is there a conflict in your schedule?");
// console.log(typeof(isConflict));
//
// alert(canEnroll(isFull, isConflict));
...
// }
//
// var inputNumberOfProducts = prompt("How many products are you ordering?");
//
